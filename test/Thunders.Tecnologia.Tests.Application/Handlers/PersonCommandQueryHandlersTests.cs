...
namespace Thunders.Tecnologia.Tests.Application.Handlers
{
    public class PersonCommandQueryHandlersTests
    {
        ...
        public async Task GetAllPersonsQueryHandler_ShouldReturnPersonDtoList_WhenPersonsExist()
        {
            ...
            {
                new PersonDto {Id = Guid.NewGuid(), Name = "John Doe", DateOfBirth = DateTime.Today.AddYears(-30), Email = "john.doe@example.com"},
                new PersonDto {Id = Guid.NewGuid(), Name = "Jane Doe", DateOfBirth = DateTime.Today.AddYears(-25), Email = "jane.doe@example.com"}
            };
